...
function est_doppler_f(rcv, lat, lon, vel, heading, ICAO)
    ...
    interested_start = find(freq_axis > -1200, 1, 'first');
    interested_end = find(freq_axis < 1200, 1, 'last');
    ...
    % Coordinates of mathwork's office
    % md_lat = 42.300919;
    % md_long = -71.350977;
    ...
    observed_lat = lat;
    observed_long = lon + 360;
    observed_velocity = vel;
    observed_heading = heading * pi / 180;
    
    
    azimuth = azimuth_deg(observed_lat, observed_long, md_lat, md_long);
    ...
    disp(['    dθ: ' num2str(azimuth) '°']);    % How many degrees cw is MD-Hall to the aircraft; cw: +, ccw: -
